    ...
    <div class="container w-25 mt-5">
        <form action="login" method="POST" data-parsley-validate="" id="#demo-form">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="password" name="password" required data-parsley-minlength="8"  data-parsley-user-distinto-password data-parsley-password-letras-numeros>
            </div>
