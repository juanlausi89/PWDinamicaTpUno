...
<body>
    <div class="container w-25 mt-5">
        <form action="enviarDatosAlumno" method="GET" data-parsley-validate="">
            ...
            <div class="form-check">
                <input value="Femenino" class="form-check-input" type="radio" name="sexo" id="sexo1" required>
                <label class="form-check-label" for="sexo1">
                    Femenino
                </label>
            </div>
            <div class="form-check">
                <input value="Masculino" class="form-check-input" type="radio" name="sexo" id="sexo2" required>
            ...
            <div class="form-check">
                <input value="No tiene estudios" class="form-check-input" type="radio" name="nivelEstudio" id="nivelEstudio1" required>
                <label class="form-check-label" for="nivelEstudio1">
                    No tiene estudios
                </label>
            </div>
            <div class="form-check">
                <input value="Estudios primarios" class="form-check-input" type="radio" name="nivelEstudio" id="nivelEstudio2" required>
                <label class="form-check-label" for="nivelEstudio2">
                    Estudios primarios
                </label>
            </div>
            <div class="form-check">
                <input value="Estudios secundarios" class="form-check-input" type="radio" name="nivelEstudio" id="nivelEstudio3" required>
            ...
            <div class="form-check">
                <input class="form-check-input" name="deportes[]" type="checkbox" value="voley" id="deporte4" required>
